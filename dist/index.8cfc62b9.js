...
var _tweet = require("./class/tweet");
var _tweetDefault = parcelHelpers.interopDefault(_tweet);
var _users = require("./class/users");
...
async function signUp() {
    ...
    const user = new (0, _usersDefault.default)(username, picture);
    try {
        await (0, _axiosDefault.default).post("http://localhost:5000/sign-up", user);
        userCurrent = user;
        loadTweets();
    } catch (error) {
        console.error(error);
...
function loadTweets() {
    (0, _axiosDefault.default).get("http://localhost:5000/tweets").then((res)=>{
...
async function postTweet() {
    ...
    const tweet = new (0, _tweetDefault.default)(userCurrent.username, text);
    try {
        await (0, _axiosDefault.default).post("http://localhost:5000/tweets", tweet);
...
},{"axios":"jo6P5","./class/tweet":"ezCp9","./class/users":"hoFRy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ezCp9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _users = require("./users");
var _usersDefault = parcelHelpers.interopDefault(_users);
class Tweet extends (0, _usersDefault.default) {
...
},{"./users":"hoFRy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hoFRy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2mNKm","6rimH"], "6rimH", "parcelRequire72cf")
